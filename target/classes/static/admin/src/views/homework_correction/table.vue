<template>
	<el-main class="bg table_wrap comtabel_t">
			...
			<el-row class="rows row2">
				...
				<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
					...
					<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button
							v-if="user_group == '管理员' || $check_action('/homework_correction/table', 'del') || $check_action('/homework_correction/view', 'del')"
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%"
			...
			<el-table-column prop="homework_grades" @sort-change="$sortChange" label="作业成绩"
				v-if="user_group == '管理员' || $check_field('get', 'homework_grades')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="200"
				v-if="user_group == '管理员' || $check_action('/homework_correction/table', 'set') || $check_action('/homework_correction/view', 'set') || $check_action('/homework_correction/view', 'get') || $check_action('//table', 'add') || $check_action('//view', 'add')">
				<template slot-scope="scope">
					<div class="view_a">
						<router-link class="e-button el-button--small is-plain el-button--success"
							style="margin: 5px !important;"
							v-if="user_group == '管理员' || $check_action('/homework_correction/table', 'set') || $check_action('/homework_correction/view', 'set') || $check_action('/homework_correction/view', 'get')"
...
export default {
	...
	data() {
		return {
			...
			showModal: false,
			// 获取数据地址
			url_get_list: "~/api/homework_correction/get_list?like=0",
			url_del: "~/api/homework_correction/del?",

      ...
      <el-row class="row_ce">
        ...
        <el-col
          ...
          <el-form-item label="院系名称">
            <el-select id="teacher_users" v-model="form['college_name1']">
              <el-option v-for="o in college_name_list" :key="o" :label="o" :value="o">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
...
import {getListTestCollege, getNameList, getListTestCourse} from "../../api/learning_resource/api";
...
export default {
  ...
  methods: {
    ...
    async getCourseNameList() {
      await getListTestCourse(this.form.teacher_users, this.form.college_name1).then((result) => {
    ...
    async getCollegeNameList() {
      ...
      await getListTestCollege(this.form.teacher_users).then((result) => {
        ...
        console.log(this.college_name_list)
        // TODO
        this.form.college_name1 = this.college_name_list.at(0);

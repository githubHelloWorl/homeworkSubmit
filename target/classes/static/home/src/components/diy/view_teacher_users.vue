		...
		<el-row class="row_ce">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="学院名称" prop="college_name">
								<el-select id="college_name" v-model="form_sub['college_name']"						v-if="user_group === '管理员' || (form_sub['teacher_users_id'] && $check_field('set','college_name')) || (!form_sub['teacher_users_id'] && $check_field('add','college_name'))">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/teacher_users/view','set') || $check_action('/teacher_users/view','add') || $check_option('/teacher_users/table','examine')">

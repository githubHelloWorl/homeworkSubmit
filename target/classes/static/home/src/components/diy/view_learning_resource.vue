	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			<el-row class="row_ce">
				...
				<el-col
					v-if="user_group != '学生用户' || $check_field('get', 'college_name') || $check_field('add', 'college_name') || $check_field('set', 'college_name')"
					:xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					<el-form-item label="学院名称" prop="college_name">
						<el-select id="college_name" v-model="form['college_name']"
							v-if="user_group != '学生用户' || (form['learning_resource_id'] && $check_field('set', 'college_name')) || (!form['learning_resource_id'] && $check_field('add', 'college_name'))">
				...
				<el-col
					v-if="user_group != '学生用户' || $check_field('get', 'professional_name') || $check_field('add', 'professional_name') || $check_field('set', 'professional_name')"
					:xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					<el-form-item label="专业名称" prop="professional_name">
						<el-select id="professional_name" v-model="form['professional_name']"
							v-if="user_group != '学生用户' || (form['learning_resource_id'] && $check_field('set', 'professional_name')) || (!form['learning_resource_id'] && $check_field('add', 'professional_name'))">
...
*/
	...
	created() {
		...
		console.log(this.list_college_name + "        " + this.list_professional_name);
	},
}
</script>

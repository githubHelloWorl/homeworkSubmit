				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 学习课程 -->
							<div><span>学习课程</span></div>
							<view_learning_resource v-if="$check_action('/learning_resource/view','get')"></view_learning_resource>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_learning_resource from "../../components/diy/view_learning_resource.vue";
	export default {
		data() {
			return {
			};

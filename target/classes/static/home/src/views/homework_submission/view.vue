				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_homework_submission v-if="$check_action('/homework_submission/view','get')"></view_homework_submission>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_homework_submission from "../../components/diy/view_homework_submission.vue";
	export default {
		data() {
			return {
			};

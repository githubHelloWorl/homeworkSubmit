				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_class_information v-if="$check_action('/class_information/view','get')"></view_class_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_class_information from "../../components/diy/view_class_information.vue";
	export default {
		data() {
			return {
			};

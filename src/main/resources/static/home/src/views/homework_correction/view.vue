				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_homework_correction v-if="$check_action('/homework_correction/view','get')"></view_homework_correction>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_homework_correction from "../../components/diy/view_homework_correction.vue";
	export default {
		data() {
			return {
			};

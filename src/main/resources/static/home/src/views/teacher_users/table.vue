				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_teacher_users v-if="$check_action('/teacher_users/table','get')"></table_teacher_users>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_teacher_users from "../../components/diy/table_teacher_users.vue";
	export default {
		data() {
			return {
			};

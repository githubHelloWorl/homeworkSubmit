				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 学生用户 -->
							<div><span>学生用户</span></div>
							<table_student_users v-if="$check_action('/student_users/table','get')"></table_student_users>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_student_users from "../../components/diy/table_student_users.vue";
	export default {
		data() {
			return {
			};

<template>
  <el-main class="bg table_wrap">
      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                      <el-button v-if="user_group == '管理员' || $check_action('/learning_resource/table','add') || $check_action('/learning_resource/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
            <el-button v-if="user_group == '管理员' || $check_action('/learning_resource/table','del') || $check_action('/learning_resource/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
                        </el-col>
                ...
                <el-table-column fixed type="selection" tooltip-effect="dark" width="55">
                      ...
                      {{ get_user_teacher_users(scope.row['teacher_users']) }}
                               ...
                               v-if="user_group == '管理员' || $check_field('get','resource_name')" min-width="200">
                                              ...
                                              <el-table-column prop="resource_images" @sort-change="$sortChange" label="课程图片"
                      ...
                      <el-image style="width: 100px; height: 100px" :src="$fullUrl(scope.row['resource_images'])"
                        ...
                        <div slot="error" class="image-slot">
                          <img src="../../../public/img/error.png" style="width: 90px; height: 90px" />
                                              ...
                                              <el-table-column prop="resource_document" @sort-change="$sortChange" label="课程文档"
                               v-if="user_group == '管理员' || $check_field('get','resource_document')" min-width="200">
                                      <template slot-scope="scope">
                      <a :href="$fullUrl(scope.row['resource_document'])" target="_blank" style="color: rgb(64, 158, 255);">点击下载</a>
                    </template>
                                </el-table-column>
                               ...
                               v-if="user_group == '管理员' || $check_field('get','resource_video')" min-width="200">
                                      <template slot-scope="scope">
                      <a href="javascript:void(0)" @click="resource_videoVideoPlay($fullUrl(scope.row['resource_video']))" >点此播放</a>
                    </template>
                                </el-table-column>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/learning_resource/table','set') || $check_action('/learning_resource/view','set') || $check_action('/learning_resource/view','get') || $check_action('/${table.tableConfig.table_nav_name}/table','add') || $check_action('/${table.tableConfig.table_nav_name}/view','add')" >
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                                                      ...
                                                                      <router-link v-if="user_group == '管理员' || $check_comment('/learning_resource/table')" class="el-button el-button--small is-plain el-button--primary"
                             :to="'../comment/table?size=10&page=1&source_table=learning_resource&source_field=' + field + '&source_id=' + scope.row[field]" size="small">
                  查看评论
                </router-link>
                                        </template>
    </el-table-column>
    ...
    <!-- /分页器 -->
                                                                                                            ...
                                                                                                            <el-dialog
                title="视频详情"
                :visible.sync="resource_videoPlayerModalVisible"
                width="30%"
            >
